...
class backup_local_agentdetect_plugin extends backup_local_plugin {
    ...
    protected function define_course_plugin_structure() {
        ...
        // The useragent and ipaddress fields are deliberately excluded from
        // backups: they are personal identifiers, and there is no use case for
        // replaying them on a restored-elsewhere instance. The Privacy API
        // still covers per-user export and deletion of these fields on the
        // live database.
